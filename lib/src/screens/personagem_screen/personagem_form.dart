...
class PersonagemDetalheForm extends StatefulWidget {
  final Usuario usuario;
  final Personagem personagem;

  PersonagemDetalheForm({
    @required this.usuario,
    @required this.personagem,
  });
  @override
  _PersonagemDetalheFormState createState() =>
      _PersonagemDetalheFormState(personagem: personagem);
}

class _PersonagemDetalheFormState extends State<PersonagemDetalheForm> {
  final Personagem personagem;

  _PersonagemDetalheFormState({@required this.personagem});
